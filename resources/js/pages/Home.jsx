            ...
            <main className="space-y-5">
                    ...
                    <ol className="list-decimal pl-6 text-white mb-4">
                        <li>
                            <code className="bg-[#1C232B] px-1 rounded">
                                git clone https://github.com/RevanSP/LARAVEL-REACT-MONOLITH-VERCEL-TEMPLATE.git
                            </code>
                        </li>
                        <li>
                            <code className="bg-[#1C232B] px-1 rounded">
                ...
                <section className="shadow-md rounded-lg p-6 bg-[#15181D]">
                    ...
                    <p className="mb-4">
                        ...
                        <code className="bg-[#1C232B] px-1 rounded">/api/api/status</code>{' '}
                        route on Vercel.
                    </p>
                    <p className="mb-4">
                        Example URL:{' '}
                        <code className="bg-[#1C232B] px-1 rounded">
                            https://laravel-vercel-preview.vercel.app/api/api/status
                        </code>
                    </p>
  ...
  "database": {
    ...
    "database": "$database"
                    ...
                    <p className="mt-4">
                        ...
                        <code className="bg-[#1C232B] px-1 rounded">/api/status</code>{' '}
                        (without the extra <code className="bg-[#1C232B] px-1 rounded">/api</code> prefix).
                    </p>
                </section>
                ...
                <section className="shadow-md rounded-lg p-6 bg-[#15181D]">
                    ...
                    <p className="mb-4">
                        You must add the <code className="bg-[#1C232B] px-1 rounded">APP_KEY</code>{' '}
                        from your <code className="bg-[#1C232B] px-1 rounded">.env</code>{' '}
                        file into the <code className="bg-[#1C232B] px-1 rounded">vercel.json</code>{' '}
                        configuration. To do this, follow these steps:
                    </p>
                    <ol className="list-decimal list-inside space-y-2 mb-4">
                        <li>
                            Generate your <code className="bg-[#1C232B] px-1 rounded">APP_KEY</code>{' '}
                            using the command{' '}
                            <code className="bg-[#1C232B] px-1 rounded">php artisan key:generate</code>
                        </li>
                        <li>
                            Copy the generated key from{' '}
                            <code className="bg-[#1C232B] px-1 rounded">.env APP_KEY</code>{' '}
                            field into the <code className="bg-[#1C232B] px-1 rounded">vercel.json</code> file
                        </li>
                    </ol>
                    <pre className="p-4 rounded-md text-sm overflow-x-auto">
                        {`{
   //
    ...
    //
                ...
                <section className="shadow-md rounded-lg p-6 bg-[#15181D]">
                    ...
                    <p className="mb-4">
                        This free service allows you to connect to a remote MySQL database for testing purposes.
                        Please note that this is not intended for production use, but it provides an easy way to
                        experiment and test your database connections.
                    </p>
                    <p className="mb-4">
                    ...
                    <ol className="list-decimal pl-6 text-white mb-4">
                        <li>
                            ...
                            <a href="https://freedb.tech/register.html" className="bg-text-gradient bg-clip-text text-transparent">
                                https://freedb.tech/register.html
                            </a>{' '}
                            and register using your email, or create a dummy account through{' '}
                            <a href="https://temporary-mail-generator.vercel.app" className="bg-text-gradient bg-clip-text text-transparent">
                                https://temporary-mail-generator.vercel.app
                            </a>.
                        </li>
                        <li>
                            <strong>Verify your email:</strong> After registration, check your email to verify your account.
                        </li>
                        <li>
                            <strong>Create a database and user:</strong> Go to your{' '}
                            <a href="https://freedb.tech/dashboard/" className="bg-text-gradient bg-clip-text text-transparent">
...
DB_PASSWORD=                // Add your PASSWORD here`}
                        ...
                        <li>
                            ...
                            <a href="https://phpmyadmin.freedb.tech/" className="bg-text-gradient bg-clip-text text-transparent">
                                https://phpmyadmin.freedb.tech
                            </a>, and log in using the server, username, and password you just created in the{' '}
                            <a href="https://freedb.tech/dashboard/" className="bg-text-gradient bg-clip-text text-transparent">
                                https://freedb.tech/dashboard
                            </a>.
                        </li>
                        <li>
                            <strong>Import your local database (optional):</strong> If you have an existing SQL database,
                            you can export it from your local phpMyAdmin and import the{' '}
                            <code className="bg-[#1C232B] px-1 rounded">.sql</code>{' '}
                ...
                <section className="shadow-md rounded-lg p-6 bg-[#15181D]">
                    ...
                    {dbStatus && (
                        <>
                            {dbStatus.status && dbStatus.status.includes('successfully') ? (
                                <>
                                    <p className="text-green-500">{dbStatus.status}</p>
                                    <p className="text-blue-500">
                                        <strong>MySQL Version:</strong> {dbStatus.version}
                                    </p>
                                    <p className="text-blue-500">
                                        <strong>Host:</strong> {dbStatus.host}
                                    </p>
                                    <p className="text-blue-500 mb-4">
                                        <strong>Database Name:</strong> {dbStatus.database}
                                    </p>
                                </>
                            ) : (
                                <>
                                    <p className="text-red-500">{dbStatus.status}</p>
                                    {dbStatus.errorDetails && (
                                        <p className="text-red-500 mb-4">
                                            <strong>Error Details:</strong> {dbStatus.errorDetails}
                                        </p>
                                    )}
                                </>
                            )}
                    ...
                    <p className="mb-4">
                        The status above could be either "Connected successfully!" or "Connection failed!."
                        As mentioned earlier, this is not suitable for production use, but it is perfect for
                        testing or demo projects.
                    </p>
                    <p className="mb-4">
                        If you need storage, you can use the Cloudinary service for free, or simply convert
                        each uploaded file into base64 (not recommended) in your CRUD Controller logic.
                    </p>
                </section>
                ...
                <section className="shadow-md rounded-lg p-6 bg-[#15181D]">
                    ...
                    <ul className="list-disc list-inside space-y-2">
                        <li>
                            In Vercel, go to <strong>Settings</strong> → <strong>General</strong>, and under{' '}
                            <strong>Build & Development Settings</strong>, set the <strong>Output Directory</strong> to{' '}
                            <code className="bg-[#1C232B] px-1 rounded">public</code>.
                        </li>
                        <li>
                            Set <strong>Node.js Version</strong> to <strong>18.x or higher</strong> (but not the latest version)
                            and then redeploy.
                        </li>
                    </ul>
                </section>
